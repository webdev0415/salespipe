...
export class languages1633779782783 implements MigrationInterface {
  name = 'languages1633779782783';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`user_profiles\` ADD \`languages\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
